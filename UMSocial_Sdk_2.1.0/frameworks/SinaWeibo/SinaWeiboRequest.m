...
{
    NSString *copyString = [self mutableCopy];
    SAFE_ARC_AUTORELEASE(copyString);
    NSString *returnString = (NSString *) CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(NULL, (CFStringRef) copyString, NULL, CFSTR("￼=,!$&'()*+;@?\n\"<>#\t :/"), encoding));
    return returnString;
}
...
//    [super dealloc];
    ...
    SAFE_ARC_RELEASE(httpMethod);
    SAFE_ARC_RELEASE(params);
    SAFE_ARC_RELEASE(responseData);
...
//        SAFE_ARC_RELEASE(escaped_value);
    }
