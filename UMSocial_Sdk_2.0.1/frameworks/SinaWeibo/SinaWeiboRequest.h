...
{
    SinaWeibo          __unsafe_unretained             *sinaweibo;//weak reference
    ...
    id<SinaWeiboRequestDelegate> __unsafe_unretained delegate;
}

@property (nonatomic, unsafe_unretained) SinaWeibo *sinaweibo;
@property (nonatomic, retain) NSString *url;
@property (nonatomic, retain) NSString *httpMethod;
@property (nonatomic, retain) NSDictionary *params;
@property (nonatomic, unsafe_unretained) id<SinaWeiboRequestDelegate> delegate;
