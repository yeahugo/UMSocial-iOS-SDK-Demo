...
- (void)dealloc {
    ...
    _shareButton = nil;
    [_accountButton removeFromSuperview];
    _accountButton = nil;
...
//    UMLog(@"update Button Number likeCount is %d shareCount is %d commentCount is %d",[socialData getNumber:UMSNumberLike],[socialData getNumber:UMSNumberShare],[socialData getNumber:UMSNumberLike],[socialData getNumber:UMSNumberComment]);
