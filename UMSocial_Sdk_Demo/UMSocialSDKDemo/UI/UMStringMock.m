...
+ (NSString *) longWords{
  NSInteger wordsCount = rand()%(kLongWordsMaximal-kLongWordsMinimal)+kLongWordsMinimal;
  NSMutableString * retString = [NSMutableString string];
  NSArray * words = [UMStringMock words];
  NSUInteger count = [words count];
  for (int i = 0 ; i<wordsCount ; i++) {
...
+ (NSString *) nameMockString{
  NSArray * words = [UMStringMock words];
  NSUInteger count = [words count];
  NSString * title = [[UMStringMock words] objectAtIndex:rand()%count];
  return title;
}
+ (NSString *) chineseNameMockString{
  NSArray * lastName = [self lastName];
  NSArray * firstName = [self firstName];
  NSInteger maxLastNameCount = [lastName count];
  NSInteger maxFirstNameCount = [firstName count];
  
  NSMutableString * name = [NSMutableString stringWithString:[lastName objectAtIndex:rand()%maxLastNameCount]];
  [name appendString:[firstName objectAtIndex:rand()%maxFirstNameCount]];
  return name;
}
...
+ (NSString *) shortDescriptionMockString{
  return [self shortWords];
}
+ (NSString *) longDescriptionMockString{
  return [self longWords];  
}
...
+ (NSString *) latitudeString{
  ...
  double latitude = (arc4random()%(360*100000000))/10000000.0-180.0;
...
+ (NSString *) longitudeString{
  NSString * longitudeString;
  double longitude = (arc4random()%(180*100000000))/10000000.0-90.0;
